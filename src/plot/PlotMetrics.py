...
if __name__ == '__main__':
    ...
    for algo_name in all_algos:
        ...
        writer = LoggingWriter.load(pickle_folder)

        train_epochs[algo_name] = writer.retrieve_information("train_accuracy")[0]
        train_accuracies[algo_name] = writer.retrieve_information("train_accuracy")[1]
        train_losses[algo_name] = writer.retrieve_information("train_loss")[1]

        test_epochs[algo_name] = writer.retrieve_information("test_accuracy")[0]
        test_accuracies[algo_name] = writer.retrieve_information("test_accuracy")[1]
        test_losses[algo_name] = writer.retrieve_information("test_loss")[1]

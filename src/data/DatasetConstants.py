...
from src.optim.Metric import dice, auc, c_index, accuracy, l1_accuracy
from src.optim.nn.Nets import LinearRegression, LogisticRegression, TcgaRegression, CNN_CIFAR10, CNN_MNIST, \
    HeartDiseaseRegression, GoogleNetTransferLearning, LiquidAssetRegression
...
NB_CLIENTS = {"mnist": 6, "fashion_mnist": 10, "cifar10": 7, "camelyon16": 2, "heart_disease": 4, "isic2019": 6,
              "ixi": 3, "kits19": 6, "lidc_idri": 5, "tcga_brca": 6, "liquid_asset": 100}
...
MODELS = {"mnist": CNN_MNIST, "cifar10": GoogleNetTransferLearning, "heart_disease": HeartDiseaseRegression,
          "tcga_brca": TcgaRegression, "ixi": UNet, "liquid_asset": LiquidAssetRegression}
CRITERION = {"mnist": nn.CrossEntropyLoss, "cifar10": nn.CrossEntropyLoss, "heart_disease": nn.BCELoss,
             "tcga_brca": CoxLoss, "ixi": DiceLoss, "liquid_asset": L1WeightedAccuracyLoss}
...
STEP_SIZE = {"mnist": 0.01, "cifar10": 0.001, "tcga_brca": .01, "heart_disease": 0.01, "ixi": 0.001,
             "liquid_asset": 0.01}
BATCH_SIZE = {"mnist": 256, "cifar10": 256, "tcga_brca": 4, "heart_disease": 4, "ixi": 128, "liquid_asset": 16}
MOMENTUM = {"mnist": 0., "cifar10": 0., "tcga_brca": 0, "heart_disease": 0.9, "ixi": 0.95, "liquid_asset": 0}

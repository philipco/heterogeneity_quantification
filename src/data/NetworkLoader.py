...
def get_network(dataset_name: str, algo_name: str, nb_initial_epochs: int):
    ...
    if dataset_name in ["mnist", "cifar10"]:
        ...
        X_train, X_val, X_test, Y_train, Y_val, Y_test, natural_split \
            = get_data_from_pytorch(DATASET[dataset_name], NB_CLIENTS[dataset_name], split_type,
        ...
        X_train, X_val, X_test, Y_train, Y_val, Y_test, natural_split \
            = get_data_from_flamby(DATASET[dataset_name], NB_CLIENTS[dataset_name], dataset_name,
                                   kwargs_dataloader=dict(batch_size=BATCH_SIZE[dataset_name], shuffle=False))
    return Network(X_train, X_val, X_test, Y_train, Y_val, Y_test, BATCH_SIZE[dataset_name],

...
if __name__ == '__main__':
    ...
    for algo_name in all_algos:
        ...
        if algo_name == "fednova":
            fednova_training(network, nb_of_synchronization=30)
        if algo_name == "all_for_one":
            all_for_one_algo(network, nb_of_synchronization=30)
        if algo_name == "all_for_one_loss":
            all_for_one_algo(network, nb_of_synchronization=30, collab_based_on="loss")
        if algo_name == "all_for_one_pdtscl":
            all_for_one_algo(network, nb_of_synchronization=30, collab_based_on="pdtscl")
        if algo_name == "all_for_one_ratio":
            all_for_one_algo(network, nb_of_synchronization=30, collab_based_on="ratio")

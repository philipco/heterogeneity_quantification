...
if __name__ == '__main__':
    ...
    metrics_LSR = Metrics(dataset_name, "LSR", data_decentralized.nb_of_clients, data_decentralized.nb_points_by_clients)
    ...
    for i in range(1):
        ...
        compute_matrix_of_distances(function_to_compute_LSR_error, data_decentralized, metrics_LSR, symetric_distance=False)

        ### We need to resplit the iid dataset.
        # TODO : il faut aussi ré-entraier.
